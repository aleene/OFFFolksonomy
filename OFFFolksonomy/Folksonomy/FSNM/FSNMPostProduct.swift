...
/// function to hide the intricates of the URL Stats API from the user
    func PostProductTag(_ tag: FSNM.Product, for editor:String?, has token: String?, completion: @escaping (_ result: (Result<[FSNM.ProductTags], Error>?, Result<FSNM.ValidationError, Error>?) ) -> Void) {
