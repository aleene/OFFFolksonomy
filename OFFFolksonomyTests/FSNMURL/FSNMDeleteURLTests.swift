...
class FSNMDeleteURLTests: XCTestCase {
    ...
    func testProduct() throws {
        ...
        let url = URL.FSNMDeleteURL(for: .food, with: OFFBarcode(barcode: barcodeToTest), and: keyToTest, version: version, by: nil)
    ...
    func testProductBeauty() throws {
        ...
        let url = URL.FSNMDeleteURL(for: .beauty, with: OFFBarcode(barcode: barcodeToTest), and: keyToTest, version: version, by: nil)
        XCTAssertEqual(url.description, result)
    }
    ...
    func testProductPetFood() throws {
        ...
        let url = URL.FSNMDeleteURL(for: .petFood, with: OFFBarcode(barcode: barcodeToTest), and: keyToTest, version: version, by: nil)
        XCTAssertEqual(url.description, result)
    }
    ...
    func testProductProduct() throws {
        ...
        let url = URL.FSNMDeleteURL(for: .product, with: OFFBarcode(barcode: barcodeToTest), and: keyToTest, version: version, by: nil)
        XCTAssertEqual(url.description, result)
    }
    ...
    func testProductOwner() throws {
        ...
        let url = URL.FSNMDeleteURL(for: .food, with: OFFBarcode(barcode: barcodeToTest), and: keyToTest, version: version, by: owner)
        XCTAssertEqual(url.description, result)
    }
