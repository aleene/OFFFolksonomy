...
class FSNMURLStatsTests: XCTestCase {
    ...
    func testProductStats() throws {
        ...
        let url = URL.folksonomyStats(for: .food, with: nil, and: nil, by: nil )
    ...
    func testProductStatsKeyAndValue() throws {
        ...
        let url = URL.folksonomyStats(for: .food, with: key, and: value, by: nil )
        XCTAssertEqual(url.description, result)
    }
    ...
    func testProductStatsOwnerAndValue() throws {
        ...
        let url = URL.folksonomyStats(for: .food, with: nil, and: value, by: owner )
        XCTAssertEqual(url.description, result)
    }
